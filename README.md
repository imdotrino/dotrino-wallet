...
> **Parte del ecosistema [Dotrino](https://dotrino.com).** Dotrino es un
> ecosistema de aplicaciones centradas en la privacidad de los datos: tu
> información es tuya, y las decisiones sobre ella también — qué compartes,
> con quién, cuándo y por qué. Sin anuncios, sin cookies, sin rastreo de
> datos, sin vender tu identidad a nadie.
